...
{
    public class ApiBuyBuyReturnController : ApiController
    {
        ...
        public ApiBuyBuyReturnController()
        {
        ...
        //Grid level data
        [System.Web.Http.Route("api/ApiBuyBuyReturnController/GetItemList")]
        ...
        [Route("api/ApiBuyBuyReturnController/grid/addData")]
        [HttpPost]
        public HttpResponseMessage AddData(PharmacyDTO model)
        {
            ...
            if (checkData.Count == 0)
            {
                ...
                pharmacy.SUPPLIERID = model.SUPPLIERID;
                ...
                BuyBuyReturnController controller = new BuyBuyReturnController();
        ...
        [Route("api/ApiBuyBuyReturnController/grid/addData_UpdatePage")]
        [HttpPost]
        ...
        [Route("api/ApiBuyBuyReturnController/grid/UpdateData")]
        [HttpPost]
        ...
        [Route("api/ApiBuyBuyReturnController/grid/DeleteData")]
        [HttpPost]
