...
{
    public class ApiIssueController : ApiController
    {
        ...
        //Grid level data
        [System.Web.Http.Route("api/ApiIssueController/GetItemList")]
        ...
        [Route("api/ApiIssueController/grid/addData")]
        [HttpPost]
        public HttpResponseMessage AddData(PharmacyDTO model)
        {
            ...
            var checkMemoNo = (from n in db.HmsPharmacyDbSet where n.COMPID == model.COMPID && n.TRANSTP == model.TRANSTP && n.TRANSMY == model.TRANSMY && n.TRANSNO == model.TRANSNO && n.INSUSERID == model.INSUSERID
            ...
            if (checkData.Count == 0)
            {
                ...
                pharmacy.DEPTFR = model.DEPTFR;
                pharmacy.DEPTTO = model.DEPTTO;
        ...
        [Route("api/ApiIssueController/grid/addData_UpdatePage")]
        [HttpPost]
        ...
        [Route("api/ApiIssueController/grid/UpdateData")]
        [HttpPost]
        ...
        [Route("api/ApiIssueController/grid/DeleteData")]
        [HttpPost]
