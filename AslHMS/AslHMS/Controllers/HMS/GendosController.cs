...
{
    public class GendosController : AppController
    {
        ...
        public void Insert_Gendos_LogData(GendosDTO model)
        {
            ...
            aslLog.TABLEID = "HMS_GENDOS";
            aslLog.LOGDATA = Convert.ToString("Gendos Information Page. Gendos type: " + model.GDTP + ",\nGendos name :" + model.GDNM + ",\nRemarks: " + model.REMARKS + ".");
        ...
        public void update_Gendos_LogData(GendosDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        public void Delete_gendos_LogData(GendosDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        public void Delete_gendos_LogDelete(GendosDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
            ...
            AslDelete.TABLEID = "HMS_GENDOS";
            AslDelete.DELDATA = Convert.ToString("Gendos Information Page. Gendos type: " + model.GDTP + ",\nGendos name :" + model.GDNM + ",\nRemarks: " + model.REMARKS + ".");
