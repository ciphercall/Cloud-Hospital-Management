            ...
            else
            {
                var selectdata =
                    (from n in db.HMS_OPDMST
                     where n.COMPID == model.COMPID && n.PATIENTID == model.PatientID
                     select n).ToList();
                ...
                foreach (var opdMaster in selectdata)
                {
                    ...
                    opdMaster.PATIENTYYID = opdMaster.PATIENTYYID;
                    ...
                    opdMaster.DUEHID = model.DueHosID;
                ...
                var selectdata_from_opd =
                    (from n in db.HMS_OPD where n.COMPID == model.COMPID && n.PATIENTID == model.PatientID select n)
                        .ToList();
                foreach (var opd in selectdata_from_opd)
                {
                    opd.COMPID = opd.COMPID;
                    opd.PATIENTID = opd.PATIENTID;
                    opd.PATIENTYYID = opd.PATIENTYYID;
        ...
        public ActionResult UpdatePost(OpdDTO model, string command)
        {
            ...
            else
            {
                ...
                foreach (var opdMaster in selectdata)
                {
                    ...
                    opdMaster.PATIENTYY = opdMaster.PATIENTYY;
                ...
                foreach (var opd in selectdata_from_opd)
                {
                    ...
                    opd.PATIENTYYID = opd.PATIENTYYID;
                    opd.TRANSDT = opd.TRANSDT;
                    opd.TRANSMY = opd.TRANSMY;
                    opd.TRANSNO = opd.TRANSNO;
                    opd.PATIENTYY = opd.PATIENTYY;
