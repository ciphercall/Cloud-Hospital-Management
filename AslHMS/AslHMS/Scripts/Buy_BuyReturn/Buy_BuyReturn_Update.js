...
BuyBuyReturnApp.controller("ApiBuyBuyReturnController", function ($scope, $http) {
    ...
    $scope.search = function (event) {
        ...
        if (companyid != "" && transNo != "" && transactionType != "" && transMonthYear != "" && supplierName != "" && departmentName != "") {
            ...
            $.getJSON(
                     '/BuyBuyReturn/GetPaymentInfo', { "Companyid": companyid, "TransNo": transNo, "TransactionType": transactionType, "TransMonthYear": transMonthYear },
                     function (myData) {
    ...
    $scope.addrow = function (event) {
        ...
        if (insert == "I") {
            ...
            if (this.newChild.MEDIID != "" && this.newChild.MEDIID != 0 && this.newChild.MEDINM != "" && this.newChild.TRANSDT != "" && this.newChild.TRANSNO != "" && this.newChild.SupplierName != "" && this.newChild.DepartmentName != "" && this.newChild.QTY != 0 && this.newChild.QTY != "") {
                $http.post('/api/ApiBuyBuyReturnController/grid/addData_UpdatePage', this.newChild).success(function (data, status, headers, config) {
