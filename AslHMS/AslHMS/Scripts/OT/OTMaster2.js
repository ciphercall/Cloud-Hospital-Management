...
OTApp.controller("ApiOTMasterController", function ($scope, $http) {
    ...
    $scope.update = function (event) {
        ...
        $http.get('/api/ApiOTMaster/GetData2/', {
            params: {
                Compid: compid,
    ...
    $scope.addrow = function () {
        ...
        if (this.newChild.TransactionDate != "" && this.newChild.TransYear != "" && this.newChild.TransNo != ""
            ...
            $http.post('/api/grid/OTChild2', this.newChild).success(function (data, status, headers, config) {
    ...
    $scope.save = function () {
        ...
        $http.post('/apiOTMaster/SaveData2', this.item).success(function (data) {
            if (data.OTPID != 0) {
