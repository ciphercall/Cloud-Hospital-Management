...
MediCareApp.controller("ApiMediCareController", function ($scope, $http) {
    ...
    $scope.addrow = function (event) {
        ...
        if (insert == "I") {
            ...
            this.newChild.GENERICID = $('#genericNameID option:selected').val();
            this.newChild.DOSAGEFID = $('#dosageNameID option:selected').val();
            this.newChild.UNIT = $('#UnitID').val();
            this.newChild.BUYRT = $('#BuyRateID').val();
            this.newChild.SALRT = $('#SaleRateID').val();
            this.newChild.STKMIN = $('#StockMinimumID').val();
